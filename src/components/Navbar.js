...
export default function Navbar() {
 ...
 <Link className="text-gray-300 px-3 py-2 rounded-md text-sm font-medium" aria-current="page" to="/about">About</Link>
 <Link className="text-gray-300 px-3 py-2 rounded-md text-sm font-medium" aria-current="page" to="/">Home</Link>
